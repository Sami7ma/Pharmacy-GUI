...
public class PharmacyManagementApp {
    ...
    public void displayGUI() {
        ...
        tabbedPane.addTab("Add Customers", new CustomerTab().createCustomerPanel());
        tabbedPane.addTab("Add Products", new ProductTab().CreateProductPanel());
        tabbedPane.addTab("Add Suppliers", new SupplierTab().createSupplierPanel());
        tabbedPane.addTab("Add to Inventory", new InventoryTab().createInventoryPanel());
        tabbedPane.addTab("Make Sales", new SalesTab().createSalePanel());
        tabbedPane.addTab("History", new HistoryTab().createHistoryPanel());
